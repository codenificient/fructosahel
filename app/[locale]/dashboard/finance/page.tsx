...
export default function FinancePage() {
  ...
  const handleCreateSale = () => {
    ...
    try {
      createSale.mutate({
        ...
        saleDate:
          saleForm.saleDate instanceof Date
            ? saleForm.saleDate.toISOString()
            : String(saleForm.saleDate),
      });
    } catch (err) {
      toast({
        variant: "error",
  ...
  const netProfit =
    transactionsData?.totals.balance !== undefined
      ? transactionsData.totals.balance
                ...
                <div className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          const price =
                            parseFloat(String(saleForm.pricePerKg)) || 0;
                          setSaleForm((prev) => ({
                            ...prev,
                            quantityKg,
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          const qty =
                            parseFloat(String(saleForm.quantityKg)) || 0;
                          setSaleForm((prev) => ({
                            ...prev,
                            pricePerKg,
                            totalAmount: String(qty * price),
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input
                      ...
                      value={
                        saleForm.saleDate instanceof Date
                          ? saleForm.saleDate.toISOString().split("T")[0]
                          : saleForm.saleDate || ""
                      }
                      onChange={(e) =>
                        setSaleForm((prev) => ({
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input
                      type="date"
                      value={
                        transactionForm.transactionDate instanceof Date
